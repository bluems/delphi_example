...
begin
  ListBox1.Position.X := Form1.ClientWidth;  // 숨겨진 상태
  ListBox1.Position.Y := 0;
end;
...
begin
  // ShadowEffect 효과 재반영.
   ...
   begin
     ListBox1.Tag := 1;
     ListBox1.AnimateFloat( 'Position.X', Form1.ClientWidth - ListBox1.Width, 1  );  // 나타남
   end
   else
   begin
     ListBox1.Tag := 0;
     ListBox1.AnimateFloat( 'Position.X', Form1.ClientWidth, 1  );                   // 숨겨짐
   end;
end;
...
begin
   ...
   begin
     ListBox1.Tag := 0;
     ListBox1.AnimateFloat( 'Position.X', Form1.ClientWidth, 1  );
   end;
end;
